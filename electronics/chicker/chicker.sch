EESchema Schematic File Version 2  date 11/25/2010 12:42:57 AM
LIBS:power
LIBS:device
LIBS:transistors
LIBS:conn
...
U 1 1 4CEE1E44
P 1950 1150
F 0 "#PWR01" H 1950 1150 30  0001 C CNN
...
U 1 1 4CEE1E3A
P 2950 1050
F 0 "#PWR02" H 2950 1050 30  0001 C CNN
...
U 1 1 4CEE06B9
P 2100 900
F 0 "#FLG03" H 2100 1170 30  0001 C CNN
...
U 1 1 4CEE06B2
P 1700 950
F 0 "#FLG04" H 1700 1220 30  0001 C CNN
...
U 1 1 4CEDE441
P 6950 5350
F 0 "#PWR05" H 6950 5300 20  0001 C CNN
...
U 1 1 4CEDE432
P 2700 5750
F 0 "#PWR07" H 2700 5750 30  0001 C CNN
...
U 1 1 4CEDE42F
P 2700 5350
F 0 "#PWR08" H 2700 5300 20  0001 C CNN
...
U 1 1 4CEDE40D
P 6450 2400
F 0 "#PWR09" H 6450 2360 30  0001 C CNN
...
U 1 1 4CEDE40C
P 6450 2800
F 0 "#PWR010" H 6450 2800 30  0001 C CNN
...
U 1 1 4CEDE400
P 6100 2400
F 0 "#PWR011" H 6100 2360 30  0001 C CNN
...
U 1 1 4CEDE3E9
P 2200 3000
F 0 "#PWR013" H 2200 3000 30  0001 C CNN
...
U 1 1 4CEDE3E3
P 2200 2600
F 0 "#PWR014" H 2200 2550 20  0001 C CNN
...
U 1 1 4CEDE369
P 5650 3850
F 0 "#PWR015" H 5650 3850 30  0001 C CNN
...
U 1 1 4CEDE359
P 5650 2600
F 0 "#PWR016" H 5650 2560 30  0001 C CNN
...
U 1 1 4CEDC077
P 6500 6850
F 0 "#PWR017" H 6500 6850 30  0001 C CNN
...
U 1 1 4CEDC076
P 2350 6850
F 0 "#PWR018" H 2350 6850 30  0001 C CNN
...
U 1 1 4CEDC06F
P 6500 5650
F 0 "#PWR019" H 6500 5600 20  0001 C CNN
...
U 1 1 4CEDC06C
P 2350 5650
F 0 "#PWR020" H 2350 5600 20  0001 C CNN
...
U 1 1 4CEDBFD3
P 8000 6550
F 0 "#PWR021" H 8000 6550 30  0001 C CNN
...
U 1 1 4CEDBFD0
P 3800 6550
F 0 "#PWR022" H 3800 6550 30  0001 C CNN
...
U 1 1 4CE86E2E
P 3950 2000
F 0 "#PWR023" H 3950 2000 30  0001 C CNN
...
U 1 1 4CE86E12
P 3850 4400
F 0 "#PWR024" H 3850 4400 30  0001 C CNN
...
U 1 1 4CE86DC4
P 3150 2500
F 0 "#PWR025" H 3150 2450 20  0001 C CNN
...
U 1 1 4CE86D89
P 3150 3850
F 0 "#PWR026" H 3150 3850 30  0001 C CNN
...
U 1 1 4CE86D14
P 1950 4100
F 0 "#PWR027" H 1950 4100 30  0001 C CNN
...
U 1 1 4CE86D10
P 1950 2900
F 0 "#PWR028" H 1950 2850 20  0001 C CNN
...
U 1 1 4CE84BC1
P 3450 1350
F 0 "#PWR029" H 3450 1310 30  0001 C CNN
...
U 1 1 4CE84AEC
P 1900 1450
F 0 "#PWR030" H 1900 1400 20  0001 C CNN
...
U 1 1 4CE84ADB
P 2000 900
F 0 "#PWR031" H 2000 860 30  0001 C CNN
...
U 1 1 4CE84A86
P 750 1850
F 0 "#PWR032" H 750 1850 30  0001 C CNN
...
U 1 1 4CE84A5C
P 1550 850
F 0 "#PWR033" H 1550 800 20  0001 C CNN
